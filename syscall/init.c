...
void os_sighnd(int sig, siginfo_t *info, void *ctx) {
	...
	if (0x138b == *(uint16_t *) uc->uc_mcontext.gregs[REG_RIP]) {
		...
		uc->uc_mcontext.gregs[REG_RCX] = 100000 + 8000 + counter;
		uc->uc_mcontext.gregs[REG_RIP] += 3;
	}
